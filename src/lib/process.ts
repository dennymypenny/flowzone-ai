/* The process and the straight answers, shared by / and /how-we-work so
   the two pages never drift. */
...
export const days = [
  ...
  {
    tag: "First look",
    short: "Not a mood board. A real first pass in a browser, with your words and your colors in it.",
  ...
  {
    tag: "Live",
    short: "On your domain, tested on a phone, handed over with the keys. You own it.",
