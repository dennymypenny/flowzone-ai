...
const cases = [
  ...
  },
  {
    ...
    summary: "James Okafor is a senior software architect and consultant charging $250 per hour for his time. For three years, he had been spending 15 or more hours every month â the equivalent of nearly $4,000 in billable time â on admin work: chasing invoices, following up with leads, onboarding new clients, and manually tracking project status. Four days of automation gave that time back and doubled what his practice could handle.",
