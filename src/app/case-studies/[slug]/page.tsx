...
const cases = [
  {
    ...
    quoteName: "Carlos M., Founder â Verde Supply Co.",
  },
  {
    slug: "pinnacle-media",
    ...
    solution: "We built a centralized reporting engine that pulls live data from all six platforms via API, populates each client's custom template, renders a branded PDF, and emails it to the client and their internal stakeholders â every Monday at 7:30 AM without anyone touching it.",
    steps: [
    ...
    quoteName: "Rachel T., Director of Operations â Pinnacle Media Group",
  },
  {
    slug: "sofia-navarro",
    ...
    location: "Miami, FL",
    timeline: "4 days",
    services: ["Lead Intake & CRM Systems", "Invoice & Payment Workflows", "Email Nurture Sequences"],
    headline: "How a Freelance Designer Added $42K in Revenue by Automating Her Admin",
    summary: "Sofia Navarro is a senior UX and product designer serving tech startups and growth-stage companies. Her work is in high demand â but her business was running on sticky notes, a shared Google Sheet, and memory. Leads came in through her website, Instagram DMs, and LinkedIn, and fell through the cracks regularly. Invoices went out late or not at all. And follow-up with warm prospects was nonexistent. Four days of systems changed all of that.",
    challenge: "Sofia's problem was not a lack of clients â it was a lack of systems. She was billing at a premium rate but spending 20 or more hours per month on intake, proposal writing, invoice chasing, and lead follow-up. Worse, she had no way to nurture the dozens of prospects who expressed interest but were not ready to start immediately. Those people would eventually hire someone, just not Sofia because she had not stayed in touch. A back-of-envelope calculation showed she was losing an estimated $10,000 to $15,000 per quarter in missed opportunities alone.",
    ...
    steps: [
      ...
      { step: "Milestone-Based Invoicing", detail: "Invoice systems tied to project phase. When a project phase is marked complete in Airtable, an invoice drafts automatically in Stripe with the correct amount, due date, and line items. Sends to client immediately. Overdue reminders trigger at 3, 7, and 14 days." },
    ...
    quoteName: "Sofia N., Founder â Sofia Navarro Design",
  },
  {
    slug: "regal-home",
    ...
    location: "Phoenix, AZ",
    timeline: "7 days",
    services: ["Appointment Booking & Reminders", "Lead Intake & CRM Systems", "Email Nurture Sequences"],
    ...
    quoteName: "Marcus R., Owner â Regal Home Services",
  },
  {
    ...
    location: "Denver, CO",
    timeline: "7 days",
    services: ["Lead Intake & CRM Systems", "Email Nurture Sequences", "Automated Reporting & Dashboards"],
    headline: "How a Denver Brokerage Tripled Lead Conversion and Closed $2.4M More in One Quarter",
    summary: "Northgate Realty Group is a 6-agent independent brokerage in Denver operating in one of the most competitive real estate markets in the country. They were generating 200+ leads per month from Zillow, Realtor.com, and their own site â but converting fewer than 4% of them. The problem was not the leads. It was what happened after they came in. We built a CRM and lead nurture system that changed the math entirely.",
    challenge: "Every agent had their own system for tracking leads â some used spreadsheets, some used their phone's notes app, and one was working entirely from memory. When a lead came in at 9 PM on a Saturday, it might not get a response until Monday morning. In a market where a buyer might tour 3 homes over a weekend and make an offer by Sunday, that 36-hour response gap was fatal. Northgate was also not staying in contact with leads who were 3-12 months out from buying. Those people would eventually buy â just through whoever had stayed in touch.",
    ...
    quoteName: "Derek N., Broker-Owner â Northgate Realty Group",
  },
  {
    slug: "luxe-medspa",
    client: "Luxe MedSpa",
    ...
    quoteName: "Dr. Priya S., Medical Director â Luxe MedSpa",
  },
  {
    slug: "james-okafor",
    ...
    location: "Chicago, IL",
    timeline: "4 days",
    services: ["Invoice & Payment Workflows", "Lead Intake & CRM Systems", "Automated Reporting & Dashboards"],
    headline: "How a Senior Software Consultant Doubled His Capacity by Automating His Back Office",
    summary: "James Okafor is a senior software architect and consultant charging $250 per hour for his time. For three years, he had been spending 15 or more hours every month â the equivalent of nearly $4,000 in billable time â on admin work: chasing invoices, following up with leads, onboarding new clients, and manually tracking project status. Four days of systems gave that time back and doubled what his practice could handle.",
    challenge: "James's problem was invisible until we mapped it. He was technically fully booked, but 15 hours of his monthly capacity was being consumed by tasks that had nothing to do with software: drafting invoices in Google Docs, emailing them manually, following up when they went unpaid, responding to the same onboarding questions from every new client, and losing track of warm prospects he had spoken to months earlier. He had also turned down two projects that quarter because he felt too busy â despite the fact that the busyness was largely administrative.",
    ...
    steps: [
      ...
      { step: "Milestone-Based Invoicing", detail: "Invoices now generate automatically when James marks a project milestone complete. The system pulls the client name, project code, milestone amount, and due date â drafts the invoice in Stripe â and sends it within minutes. Overdue reminders send automatically at 3, 7, and 14 days." },
      ...
      { step: "Project Status Dashboard", detail: "A lightweight weekly status email auto-generates for each active project on Friday afternoon. Summarizes hours logged, milestones completed, blockers, and next week's planned work. Clients receive it automatically â no more manual status update requests." },
    ...
    metrics: [
      ...
      { label: "Invoice Collection Time", value: "â 68%" },
    ],
    ...
    quoteName: "James O., Principal Consultant â Okafor Consulting",
  },
  {
    slug: "mesa-crossfit",
    ...
    location: "Mesa, AZ",
    timeline: "7 days",
    services: ["Email Nurture Sequences", "Appointment Booking & Reminders", "Lead Intake & CRM Systems"],
    headline: "How an Independent CrossFit Gym Reactivated 89 Lapsed Members and Cut Churn by 31%",
    summary: "Mesa CrossFit is a 240-member independent gym competing against franchise fitness chains with massive marketing budgets. Owner Tanya had built a tight community over six years, but member churn was accelerating â mostly quietly. Members would stop showing up, their membership would lapse, and the gym would never reach out. In 60 days following our engagement, 89 members came back, and monthly churn dropped by nearly a third.",
    challenge: "The typical fitness gym loses 30-50% of its members annually. Mesa CrossFit was no exception. But the problem was structural: the gym had no system for catching members before they left. When someone went two weeks without attending class, nothing happened. When their membership billing failed, an automated system cancelled them and that was it â no human touchpoint, no attempt to save the relationship. And for new members, the onboarding experience was essentially: sign the waiver, here's your keycard, good luck. First-month retention was poor because new members felt lost before they felt hooked.",
    ...
    quoteName: "Tanya K., Owner â Mesa CrossFit",
  },
];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">{cs.industry} Â· {cs.location}</p>
            </div>
          </div>
