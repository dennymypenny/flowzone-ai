...
const ROUTES: Route[] = [
  ...
  { path: "/motion-graphics", priority: 0.85, changeFrequency: "monthly", lastModified: "2026-09-23" },
  { path: "/graphic-design", priority: 0.85, changeFrequency: "monthly", lastModified: "2026-09-23" },
