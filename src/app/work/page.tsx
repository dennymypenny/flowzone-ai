        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-12 gap-10 mb-10">
            <div className="md:col-span-6">
              ...
              <h2 className="font-display text-5xl leading-none mb-4">
                A hard problem,
                <br />
                explained in 31 seconds.
              </h2>
            </div>
            <p className="md:col-span-6 text-ink-soft leading-relaxed self-end max-w-reading">
              Getting AI to produce something is easy. Getting it to do work a
              marketing team can trust is the hard part, and that is the whole
              pitch. The ad opens on the easy version, names the hard one, then
              shows the platform that closes the gap.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-12 gap-10 mt-8">
            <div className="md:col-span-5">
              <p className="label mb-3">Spec piece, made for Profound</p>
              <h3 className="font-display text-3xl leading-none mb-2">Profound</h3>
              <a
                href="https://www.tryprofound.com"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-ink-soft underline decoration-rule underline-offset-4 hover:text-ink transition-colors"
              >
                tryprofound.com
              </a>
            </div>
            <div className="md:col-span-7">
              <p className="text-ink-soft font-light leading-relaxed max-w-reading">
                Made on our own for Profound, the platform for marketing in AI
                search. It was not commissioned. It stays inside their look,
                black with one blue, and lets the type carry the argument:
                research, planning, creation and measurement snapping into one
                platform, your judgment on one end and trusted action on the
                other. It ends where a recruiting ad should, on the careers
                link.
              </p>
              <div className="border-t border-rule mt-6 pt-4 grid grid-cols-2 sm:grid-cols-4 gap-4">
                {[
                  ...
                  ["Made for", "Recruiting and social"],
                  ["Status", "Spec, not commissioned"],
                ].map(([k, v]) => (
                  <div key={k}>
                    <p className="label mb-1.5">{k}</p>
                    <p className="text-sm text-ink-soft">{v}</p>
