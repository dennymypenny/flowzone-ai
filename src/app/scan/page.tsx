...
export default function ScanPage() {
  return (
    <div className="bg-white min-h-screen">
      {/* Hero */}
      <section className="pt-24 pb-16 px-6 bg-gradient-to-b from-indigo-50 to-white">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-indigo-100 text-indigo-700 text-xs font-bold px-4 py-1.5 rounded-full mb-6 uppercase tracking-wide">
            One-Time Offer
          </div>
          ...
          <div className="text-4xl font-black text-indigo-600 mb-8">$97</div>
          <Link
            href="/intake"
            className="inline-block bg-indigo-600 text-white font-bold px-10 py-4 rounded-xl hover:bg-indigo-700 transition-colors text-lg"
          >
            Get My AI Scan
          </Link>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {deliverables.map((item) => (
              <div key={item.title} className="border border-gray-100 rounded-2xl p-6">
                <div className="inline-block bg-indigo-50 text-indigo-700 text-xs font-bold px-3 py-1 rounded-full mb-4 uppercase tracking-wide">
                  {item.icon}
                </div>
      ...
      <section className="py-16 px-6 bg-indigo-600">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-indigo-200 mb-8">Get your full AI Scan delivered in 48 hours for just $97.</p>
          <Link
            href="/intake"
            className="inline-block bg-white text-indigo-600 font-bold px-10 py-4 rounded-xl hover:bg-indigo-50 transition-colors text-lg"
          >
            Get My AI Scan — $97
          </Link>
        </div>
