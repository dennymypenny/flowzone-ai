...
const services = [
  {
    ...
    description: "Stop losing leads to slow follow-up. We capture leads from any source, score them with AI, send personalized responses within seconds, and push everything into your CRM automatically.",
  ...
  },
  {
    ...
    description: "We automate your invoicing cycle — from generating invoices when a milestone hits, to sending payment reminders, to syncing your books when payment lands.",
