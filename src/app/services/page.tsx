...
const services = [
  {
    ...
    description:
      "Every new lead gets a personalized reply in under 60 seconds — 24/7. We connect your contact forms, DMs, and ad leads into one system that responds, qualifies, and routes automatically.",
  ...
  },
  {
    ...
    description:
      "Mark a job complete and your invoice goes out automatically — pre-filled with client details, project scope, and payment link. Follow-ups send themselves if unpaid.",
  ...
  },
  {
    ...
    description:
      "Pull data from your CRM, analytics, ads, and accounting tools. Every Monday at 9am, a formatted performance report lands in your inbox — no compiling, no copy-paste.",
  ...
  },
  {
    ...
    description:
      "When a proposal is accepted, your entire onboarding sequence fires automatically: welcome email, contract, intake form, project portal access, and kickoff call link — in minutes.",
  ...
  },
  {
    ...
    description:
      "3 days after project delivery, a personalized review request goes out automatically. Happy clients leave reviews. Great clients get a referral prompt. All hands-free.",
  ...
  },
  {
    ...
    description:
      "We map every repetitive process in your business, identify the highest-ROI automations, and build them all in one sprint. Most clients recover 10+ hours per week.",
      ...
      <section className="bg-white pt-20 pb-16 px-6 border-b border-gray-100">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/intake"
              className="bg-sky-600 text-white font-bold px-8 py-4 rounded-xl hover:bg-sky-700 transition-colors"
            >
              Get Free AI Audit &rarr;
            </Link>
            <Link
              href="/case-studies"
              className="border border-gray-200 text-gray-700 font-bold px-8 py-4 rounded-xl hover:border-sky-300 hover:text-sky-600 transition-colors"
            >
              See Case Studies
            </Link>
          </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-black text-gray-900">Everything We Automate</h2>
          </div>
