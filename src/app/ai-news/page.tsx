          ...
          <>
            {/* Hero */}
                <section className="bg-white pt-20 pb-16 px-6 border-b border-gray-100">
                        <div className="max-w-4xl mx-auto text-center">
                                  <p className="text-sky-600 font-semibold text-sm uppercase tracking-wider mb-4">Stay Ahead</p>p>
            ...
            {/* News Outlets */}
                <section className="py-20 px-6 bg-white">
                        <div className="max-w-6xl mx-auto">
                                  <div className="mb-12">
                                              <p className="text-sky-600 font-semibold text-sm uppercase tracking-wider mb-3">What We Read</p>p>
                                              <h2 className="text-3xl font-black text-gray-900 mb-2">Top News Sources &amp; Newsletters</h2>h2>
                                              <p className="text-gray-500">These are the sources we follow to stay sharp — and bring that knowledge into every automation we build.</p>p>
                                  </div>div>
                          ...
                          <a
                                          ...
                                          <div className="flex items-start justify-between mb-3">
                                                            <h3 className="font-bold text-gray-900 group-hover:text-sky-600 transition-colors">{outlet.name}</h3>h3>
                                          ...
                                          <p className="text-sm text-gray-500 leading-relaxed">{outlet.description}</p>p>
                                          <p className="text-xs text-sky-500 mt-3 font-medium">Visit &#8594;</p>p>
                          </a>a>
                        ))}
                                  </div>div>
                        </div>div>
            ...
            {/* Tools */}
                <section className="py-20 px-6 bg-gray-50">
                        <div className="max-w-6xl mx-auto">
                                  <div className="mb-12">
                                              <p className="text-sky-600 font-semibold text-sm uppercase tracking-wider mb-3">The Stack</p>p>
                                              <h2 className="text-3xl font-black text-gray-900 mb-2">AI Automation Tools We Use</h2>h2>
                                              <p className="text-gray-500">The platforms powering the automations we build for clients every day.</p>p>
                                  </div>div>
                          ...
                          <a
                                          ...
                                          >
                                          <h3 className="font-bold text-gray-900 group-hover:text-sky-600 transition-colors mb-2">{tool.name}</h3>h3>
                                          <p className="text-sm text-gray-500">{tool.description}</p>p>
                          </a>a>
                        ))}
                                  </div>div>
                        </div>div>
            ...
            {/* CTA */}
                <section className="py-20 px-6 bg-sky-600">
                        <div className="max-w-3xl mx-auto text-center">
                                  <h2 className="text-4xl font-black text-white mb-4">Want Us to Build These Into Your Business?</h2>h2>
