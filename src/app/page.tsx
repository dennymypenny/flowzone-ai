      ...
      <section className="bg-white pt-20 pb-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-500">
            <span className="flex items-center gap-1.5"><span className="text-green-500">✓</span> Delivered in 7 days or less</span>
            <span className="flex items-center gap-1.5"><span className="text-green-500">✓</span> No long-term contracts</span>
            <span className="flex items-center gap-1.5"><span className="text-green-500">✓</span> 100% done-for-you</span>
          </div>
        </div>
      </section>
      <!-- File remitted for space -->
    </~
  );
}
