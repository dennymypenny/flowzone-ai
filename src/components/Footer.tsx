        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/start" className="text-sm text-ink-soft hover:text-ink transition-colors">Flow Mode</Link></li>
              <li><Link href="/scan" className="text-sm text-ink-soft hover:text-ink transition-colors">Free Scan</Link></li>
