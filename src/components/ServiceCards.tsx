...
const services = [
  {
    ...
    description: "Every new lead gets a real reply by email, SMS or DM within seconds of signing up.",
  ...
  },
  {
    ...
    description: "Invoices go out, get tracked and get chased on their own. You just watch the money land.",
  ...
  },
  {
    ...
    description: "Calendars stay in sync, reminders go out and reschedules sort themselves. Hands-free.",
  ...
  },
  {
    ...
    description: "We pull data from every tool you run and land a clean weekly summary in your inbox.",
  ...
  },
  {
    ...
    description: "Welcome emails, document collection and account setup, all done in minutes not days.",
  ...
  },
  {
    ...
    description: "Your CRM, spreadsheets and everything else stay in step. No more copy and paste.",
