...
const demos = [
  {
    ...
    clientCo: "Acme Corp",
    overlayTitle: "New Lead Replied To",
    overlayDetail: "acmecorp.com · via Contact Form",
    stat: "47",
    statUnit: "leads handled this week",
    highlight: "Avg response: 1.8 seconds",
    caption: "Every new lead gets a personalized follow-up instantly, hands-free, while you focus on the work.",
  },
  {
    ...
    overlayDetail: "SEO Campaign Setup · Built and sent for you",
    stat: "\$2,800",
    statUnit: "collected with zero follow-up",
    highlight: "Sent in 3 seconds · paid in 2 days",
    caption: "Mark a job complete and the invoice goes out on its own. No templates, no copy-paste.",
  },
  {
    ...
    clientCo: "Runs itself · Every Monday",
    ...
    caption: "We pull data from 5 tools and stitch it together. Your weekly report writes itself while you sleep.",
  },
];
